...
KisFilterMax::KisFilterMax() : KisFilter(id(), FiltersCategoryColorId, PkString("M&aximize Channel"))
{
...
KisFilterMin::KisFilterMin() : KisFilter(id(), FiltersCategoryColorId, PkString("M&inimize Channel"))
{
    setSupportsPainting(true);
    setColorSpaceIndependence(FULLY_INDEPENDENT);
    setShowConfigurationWidget(false);

...
StarShapeConfigCommand::StarShapeConfigCommand(StarShape *star, unsigned int cornerCount, double innerRadius, double outerRadius, bool convex, KUndo2Command *parent)

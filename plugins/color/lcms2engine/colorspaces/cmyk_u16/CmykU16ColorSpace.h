...
{
public:
    CmykU16ColorSpace(const PkString &name, KoColorProfile *p);
...
public:
    ...
    {
        return PkString("%1 (%2)").arg(CMYKAColorModelID.name()).arg(Integer16BitsColorDepthID.name());
    }

...
PkList< std::pair< KoID, KoID > > KisDodgeShadowsAdjustmentFactory::supportedModels() const
{
...
KoColorTransformation* KisDodgeShadowsAdjustmentFactory::createTransformation(const KoColorSpace* colorSpace, PkHash<PkString, PkVariant> parameters) const
{

...
PkList< std::pair< KoID, KoID > > KisBurnShadowsAdjustmentFactory::supportedModels() const
{
...
KoColorTransformation* KisBurnShadowsAdjustmentFactory::createTransformation(const KoColorSpace* colorSpace, PkHash<PkString, PkVariant> parameters) const
{

...
PkList< std::pair< KoID, KoID > > KisDodgeMidtonesAdjustmentFactory::supportedModels() const
{
...
KoColorTransformation* KisDodgeMidtonesAdjustmentFactory::createTransformation(const KoColorSpace* colorSpace, PkHash<PkString, PkVariant> parameters) const
{

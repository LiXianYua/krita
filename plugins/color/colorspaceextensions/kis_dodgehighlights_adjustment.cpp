...
PkList< std::pair< KoID, KoID > > KisDodgeHighlightsAdjustmentFactory::supportedModels() const
{
...
KoColorTransformation* KisDodgeHighlightsAdjustmentFactory::createTransformation(const KoColorSpace* colorSpace, PkHash<PkString, PkVariant> parameters) const
{

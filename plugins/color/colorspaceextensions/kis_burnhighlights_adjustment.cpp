...
PkList< std::pair< KoID, KoID > > KisBurnHighlightsAdjustmentFactory::supportedModels() const
{
...
KoColorTransformation* KisBurnHighlightsAdjustmentFactory::createTransformation(const KoColorSpace* colorSpace, PkHash<PkString, PkVariant> parameters) const
{

...
__KisToolSelectRectangularLocal::__KisToolSelectRectangularLocal(KoCanvasBase * canvas)
    : KisToolRectangleBase(canvas, KisToolRectangleBase::SELECT,
                           selectionToolCursorToken(dynamic_cast<KisCanvasToolServices*>(canvas), selectionToolCursorDescriptor("tool_rectangular_selection_cursor.png")))
{
...
void KisToolSelectRectangular::resetCursorStyle()
{
    if (selectionAction() == SELECTION_ADD) {
        useCursor(selectionToolCursorToken(dynamic_cast<KisCanvasToolServices*>(canvas()), selectionToolCursorDescriptor("tool_rectangular_selection_cursor_add.png")));
    } else if (selectionAction() == SELECTION_SUBTRACT) {
        useCursor(selectionToolCursorToken(dynamic_cast<KisCanvasToolServices*>(canvas()), selectionToolCursorDescriptor("tool_rectangular_selection_cursor_sub.png")));
    } else if (selectionAction() == SELECTION_INTERSECT) {
        useCursor(selectionToolCursorToken(dynamic_cast<KisCanvasToolServices*>(canvas()), selectionToolCursorDescriptor("tool_rectangular_selection_cursor_inter.png")));
    } else if (selectionAction() == SELECTION_SYMMETRICDIFFERENCE) {
        useCursor(selectionToolCursorToken(dynamic_cast<KisCanvasToolServices*>(canvas()), selectionToolCursorDescriptor("tool_rectangular_selection_cursor_symdiff.png")));
    } else {

...
__KisToolSelectOutlineLocal::__KisToolSelectOutlineLocal(KoCanvasBase * canvas)
    : KisToolOutlineBase(canvas, KisToolOutlineBase::SELECT,
                         selectionToolCursorToken(dynamic_cast<KisCanvasToolServices*>(canvas), selectionToolCursorDescriptor("tool_outline_selection_cursor.png")))
{
...
void KisToolSelectOutline::resetCursorStyle()
{
    if (selectionAction() == SELECTION_ADD) {
        useCursor(selectionToolCursorToken(dynamic_cast<KisCanvasToolServices*>(canvas()), selectionToolCursorDescriptor("tool_outline_selection_cursor_add.png")));
    } else if (selectionAction() == SELECTION_SUBTRACT) {
        useCursor(selectionToolCursorToken(dynamic_cast<KisCanvasToolServices*>(canvas()), selectionToolCursorDescriptor("tool_outline_selection_cursor_sub.png")));
    } else if (selectionAction() == SELECTION_INTERSECT) {
        useCursor(selectionToolCursorToken(dynamic_cast<KisCanvasToolServices*>(canvas()), selectionToolCursorDescriptor("tool_outline_selection_cursor_inter.png")));
    } else if (selectionAction() == SELECTION_SYMMETRICDIFFERENCE) {
        useCursor(selectionToolCursorToken(dynamic_cast<KisCanvasToolServices*>(canvas()), selectionToolCursorDescriptor("tool_outline_selection_cursor_symdiff.png")));
    } else {

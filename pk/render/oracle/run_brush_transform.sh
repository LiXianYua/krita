...
ccache c++ -std=c++17 -fwrapv \
    ...
    -I"$render_root/../color" -I"$render_root/../container" -I"$render_root/../image" \
    "$render_root/oracle/brush_transform.cpp" \
...
printf 'brush transform Qt oracle: identical\n'

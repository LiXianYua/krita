...
public:
     ...
     * should be eaten by the events filter
     */
    bool buttonPressed(Pk::MouseButton button, QEvent *event);
     ...
     * should be eaten by the events filter
     */
    bool buttonReleased(Pk::MouseButton button, QEvent *event);
     ...
     */
    void handlePolledKeys(const QVector<Pk::Key> &keys);
     ...
     */
    QVector<Pk::Key> debugPressedKeys() const;
...
private:
    ...
    template<typename T, typename U> bool tryRunSingleActionShortcutImpl(T param, U *event, const QSet<Pk::Key> &keysState, bool keyboard = true);

    void prepareReadyShortcuts();

    bool tryRunReadyShortcut( Pk::MouseButton button, QEvent* event );
    void tryActivateReadyShortcut();
    bool tryEndRunningShortcut( Pk::MouseButton button, QEvent* event );

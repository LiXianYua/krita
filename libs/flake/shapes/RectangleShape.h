 ...
 */
class KRITAFLAKE_EXPORT RectangleShape : public KoParameterShape, public SvgShape
{
public:
    RectangleShape();
...
protected:
    ...
    void moveHandleAction(int handleId, const PkPointF &point, Pk::KeyboardModifiers modifiers = Pk::NoModifier) override;

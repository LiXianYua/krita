...
#include "PkRasterDefs.h"
  ...
  /* whether PK_FT_EXPORT_VAR has been defined already.                    */
  /*                                                                       */
  /* On some systems and compilers (Win32 mostly), an extra keyword is     */
  /* necessary to compile the library as a DLL.                            */
  /*                                                                       */
#ifndef PK_FT_EXPORT_VAR
#define PK_FT_EXPORT_VAR( x )  extern  x
#endif
...
#define MINIMUM_POOL_SIZE 8192
  ...
  PK_FT_EXPORT_VAR( const PK_FT_Raster_Funcs )  pk_ft_grays_raster;

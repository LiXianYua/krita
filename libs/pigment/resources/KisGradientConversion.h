...
{
    /**
     * @brief Convert a KoAbstractGradientSP to a PkGradientStop list
     *
     ...
     * @return PkGradientStop list containing the positions and colors of the gradient
     */
    KRITAPIGMENT_EXPORT PkGradientStops toQGradientStops(KoAbstractGradientSP gradient,
                                                        KoCanvasResourcesInterfaceSP canvasResourcesInterface = nullptr);

    /**
     * @brief Convert a KoStopGradientSP to a PkGradientStop list
     *
     * For each stop in the stop gradient a PkGradientStop is created.
     *
     ...
     * @return PkGradientStop list containing the positions and colors of the gradient
     */
    KRITAPIGMENT_EXPORT PkGradientStops toQGradientStops(KoStopGradientSP gradient,
                                                        KoCanvasResourcesInterfaceSP canvasResourcesInterface = nullptr);

    /**
     * @brief Convert a KoSegmentGradientSP to a PkGradientStop list
     *
     * For each segment in the segment gradient two PkGradientStop are created,
     ...
     *
     * The opacity of the PkGradientStop color is set to 0 if the end point type is
     * FOREGROUND_TRANSPARENT_ENDPOINT or BACKGROUND_TRANSPARENT_ENDPOINT.
     *
     * If two PkGradientStop turn out to be in the same position and have the
     ...
     * @return PkGradientStop list containing the positions and colors of the gradient
     */
    KRITAPIGMENT_EXPORT PkGradientStops toQGradientStops(KoSegmentGradientSP gradient,
                                                        KoCanvasResourcesInterfaceSP canvasResourcesInterface = nullptr);

    /**
     * @brief Convert a KoAbstractGradientSP to a PkGradient
     *
     ...
     * @param canvasResourcesInterface KoCanvasResourcesInterfaceSP used if some of the gradient
     *                                 stops should take the foreground/background color
     * @return PkGradient containing stops with the positions and colors of the gradient
     */
    KRITAPIGMENT_EXPORT PkGradient* toQGradient(KoAbstractGradientSP gradient,
                                               KoCanvasResourcesInterfaceSP canvasResourcesInterface = nullptr);

    /**
     * @brief Convert a KoStopGradientSP to a PkGradient
     *
     * This function doesn't use the stop gradient's type and start/stop
     * positions to create different types of PkGradient. This just
     * creates a linear PkGradient and sets its stops using
     * toQGradientStops(KoStopGradientSP, KoCanvasResourcesInterfaceSP).
     * To get the correct type of PkGradient use KoStopGradient::toQGradient()
     *
     * @param gradient A KoStopGradientSP to convert from
     * @param canvasResourcesInterface KoCanvasResourcesInterfaceSP used if some of the gradient
     *                                 stops should take the foreground/background color
     * @return PkGradient containing stops with the positions and colors of the gradient
     */
    KRITAPIGMENT_EXPORT PkGradient* toQGradient(KoStopGradientSP gradient,
                                               KoCanvasResourcesInterfaceSP canvasResourcesInterface = nullptr);

    /**
     * @brief Convert a KoSegmentGradientSP to a PkGradient
     *
     * Creates a linear PkGradient and sets its stops using
     ...
     * @return PkGradient containing stops with the positions and colors of the gradient
     */
    KRITAPIGMENT_EXPORT PkGradient* toQGradient(KoSegmentGradientSP gradient,
                                               KoCanvasResourcesInterfaceSP canvasResourcesInterface = nullptr);

    /**
     * @brief Convert a PkGradientStop list to a krita abstract gradient
     *
     * This function makes use of toStopGradient(const PkGradientStops &)
     * to create a KoStopGradientSP that is casted to a KoAbstractGradientSP
     *
     * @param gradient A PkGradientStop list with the stops of the gradient
     * @return KoAbstractGradientSP containing stops with the positions and colors of the gradient
     */
    KRITAPIGMENT_EXPORT KoAbstractGradientSP toAbstractGradient(const PkGradientStops &gradient);

    /**
     * @brief Convert the stops of a PkGradient to a krita abstract gradient
     *
     * This function makes use of toStopGradient(const PkGradientStops &)
     * to create a KoStopGradientSP that is casted to a KoAbstractGradientSP
     *
     * @param gradient A PkGradient with the stops of the gradient
     * @return KoAbstractGradientSP containing stops with the positions and colors of the gradient
     */
    KRITAPIGMENT_EXPORT KoAbstractGradientSP toAbstractGradient(const PkGradient *gradient);
    ...
    /**
     * @brief Convert a PkGradientStop list to a KoStopGradientSP
     *
     * @param gradient A PkGradientStop list with the stops of the gradient
     * @return KoStopGradientSP containing stops with the positions and colors of the gradient
     */
    KRITAPIGMENT_EXPORT KoStopGradientSP toStopGradient(const PkGradientStops &gradient);

    /**
     * @brief Convert the stops of a PkGradient to a KoStopGradientSP
     *
     * @param gradient A PkGradient with the stops of the gradient
     * @return KoStopGradientSP containing stops with the positions and colors of the gradient
     */
    KRITAPIGMENT_EXPORT KoStopGradientSP toStopGradient(const PkGradient *gradient);
    ...
    /**
     * @brief Convert a PkGradientStop list to a krita segment gradient
     *
     ...
     */
    KRITAPIGMENT_EXPORT KoSegmentGradientSP toSegmentGradient(const PkGradientStops &gradient);

    /**
     * @brief Convert a PkGradient to a krita segment gradient
     *
     * Creates a segment gradient from the stops of the PkGradient using
     * toSegmentGradient(const PkGradientStops &)
     *
     * @param gradient A PkGradient with the stops of the gradient
     * @return KoSegmentGradientSP containing segments with the positions and colors of the gradient
     */
    KRITAPIGMENT_EXPORT KoSegmentGradientSP toSegmentGradient(const PkGradient *gradient);

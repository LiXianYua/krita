...
public:
     ...
     */
    KisPaintLayer(KisImageWSP image, const PkString& name, quint8 opacity, KisPaintDeviceSP dev);
     ...
     * @param opacity in the range between OPACITY_TRANSPARENT_U8 and OPACITY_OPAQUE_U8
     */
    KisPaintLayer(KisImageWSP image, const PkString& name, quint8 opacity);
     ...
     */
    KisPaintLayer(KisImageWSP image, const PkString& name, quint8 opacity, const KoColorSpace * colorSpace);
    /**
     * Copy Constructor
     */
...
public:
     ...
     * channels are active.
     */
    void setChannelLockFlags(const PkBitArray& channelFlags);
     ...
     */
    const PkBitArray& channelLockFlags() const;

...
public:
    ...
    KisScalarKeyframe(qreal value, PkSharedPointer<ScalarKeyframeLimits> limits);
    KisScalarKeyframe(qreal value, InterpolationMode interpMode, TangentsMode tangentMode, PkPointF leftTangent, PkPointF rightTangent, PkSharedPointer<ScalarKeyframeLimits> limits);
    ...
    void setInterpolationTangents(PkPointF leftTangent, PkPointF rightTangent, KUndo2Command* parentUndoCmd = nullptr);
    PkPointF leftTangent() const;
    PkPointF rightTangent() const;

    void setLimits(PkSharedPointer<ScalarKeyframeLimits> limits);
     ...
     */
    PkMetaObject::Connection valueChangedChannelConnection;
...
private:
    ...
    PkPointF m_leftTangent; /**< Controls part of between this and PREVIOUS keyframe. */
    PkPointF m_rightTangent; /**< Controls part of between this and NEXT keyframe. */
     ...
     */
    PkWeakPointer<ScalarKeyframeLimits> m_channelLimits;
};
...
public:
    ...
    PkSharedPointer<ScalarKeyframeLimits> limits() const;
    ...
    static PkPointF interpolate(PkPointF point1, PkPointF rightTangent, PkPointF leftTangent, PkPointF point2, qreal t);
...
private:
    ...
    static void normalizeTangents(const PkPointF point1, PkPointF &rightTangent, PkPointF &leftTangent, const PkPointF point2);

    virtual KisKeyframeSP createKeyframe() override;
    virtual PkRect affectedRect(int time) const override;
    virtual PkPair<int, KisKeyframeSP> loadKeyframe(const PkXmlElement &keyframeNode) override;
    virtual void saveKeyframe(KisKeyframeSP keyframe, PkXmlElement keyframeElement, const PkString &layerFilename) override;
